from mysql_class import Database,Excel
...
# base.insert_tulov("Umida","Tajiyeva",200000,"ingliz tili")

# base.change_dars_vaqti("Janar","Yusupova","15:00:00")

# base.SqlToJadval("uquvchilar")

# excell = Excel("uquvchilar.xlsx","Sheet")
# print(excell.read_text())

base.TableToSql("uquvchilar")